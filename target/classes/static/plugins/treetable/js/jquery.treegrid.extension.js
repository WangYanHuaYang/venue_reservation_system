(function($) {
    ...
    $.fn.bootstrapTreeTable = function(options, param) {
        ...
        target.renderRow = function(tr,item){
            $.each(options.columns, function(index, column) {
                ...
                if(index==0&&column.field=='selectItem'){
                    ...
                    tr.append(td);
                }else if(index==0&&column.field=='buttonItem'){
                    debugger
                    hasButtonItem = true;
                    var td = $('<td style="text-align:center;width:36px"></td>');
                    if(column.button!=null&&column.button!=''){
                        var _ipt = $(column.button);
                        td.append(_ipt);
                    }
                    tr.append(td);
                }else {
        ...
        target.load = function(parms){
            ...
            target.html("");
            // 构造表头
            var thr = $('<tr bgcolor="#1EAA8F" style="color: white;"></tr>');
            $.each(options.columns, function(i, item) {
                ...
                }else if(i==0&&item.field=='buttonItem'){
                    debugger
                    hasButtonItem = true;
                }else {
